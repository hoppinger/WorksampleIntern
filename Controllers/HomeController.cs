...
namespace CourseAndLectures.Controllers
{
  public class HomeController : Controller
  {
    private readonly MailOptions _mailOptions;
    private readonly CourseAndLecturesContext _context;

    public HomeController(CourseAndLecturesContext context, IOptions<MailOptions> mailOptionsAccessor)
    {
      _context = context;
