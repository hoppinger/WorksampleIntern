...
namespace CourseAndLectures.Data
{
  public static class CourseAndLecturesContextSeeds
  {
    ...
    static Lecture[] Lectures = null;
     static Action seed_Topics = null;
    static Topic[] Topics = null;

    public static void InitializePagesAndSingletons(CourseAndLecturesContext context) {
    ...
    public static void Initialize(CourseAndLecturesContext context)
    {
      ...
      seed_Courses = () => {
        ...
        if (!context.Course.Any())
        {
          var _Course = new System.Collections.Generic.List<Course>();
            ...
            _Course.Add(new Course { Id = 1, CreatedDate = DateTime.Now, Name = "Course 1", Description = "Description of courrse 1", StudyPoints = 12, Published = true,   });

            
            _Course.Add(new Course { Id = 2, CreatedDate = DateTime.Now, Name = "Course 2", Description = "Description of courrse 2", StudyPoints = 11, Published = true,   });

            
            _Course.Add(new Course { Id = 3, CreatedDate = DateTime.Now, Name = "Course 3", Description = "Description of courrse 3", StudyPoints = 12, Published = false,   });

            
            _Course.Add(new Course { Id = 4, CreatedDate = DateTime.Now, Name = "Course 4", Description = "Description of courrse 4", StudyPoints = 14, Published = false,   });
      ...
      seed_Lectures = () => {
        ...
        if (!context.Lecture.Any())
        {
          var _Lecture = new System.Collections.Generic.List<Lecture>();
            ...
            _Lecture.Add(new Lecture { Id = 1, CreatedDate = DateTime.Now, Name = "Lecture 1", Description = "Description of Lecture 1", IsPracticum = false,   });

            
            _Lecture.Add(new Lecture { Id = 2, CreatedDate = DateTime.Now, Name = "Lecture 2", Description = "Description of Lecture 2", IsPracticum = false,   });

            
            _Lecture.Add(new Lecture { Id = 3, CreatedDate = DateTime.Now, Name = "Lecture 3", Description = "Description of Lecture 3", IsPracticum = true,   });

            
            _Lecture.Add(new Lecture { Id = 4, CreatedDate = DateTime.Now, Name = "Lecture 4", Description = "Description of Lecture 4", IsPracticum = true,   });
      ...
      seed_Topics = () => {
        ...
        {
          var _Topic = new System.Collections.Generic.List<Topic>();
          
          
            
            _Topic.Add(new Topic { Id = 1, CreatedDate = DateTime.Now, Name = "Topic 1",   });

            
            _Topic.Add(new Topic { Id = 2, CreatedDate = DateTime.Now, Name = "Topic 2",   });

            
            _Topic.Add(new Topic { Id = 3, CreatedDate = DateTime.Now, Name = "Topic 3",   });

            
            _Topic.Add(new Topic { Id = 4, CreatedDate = DateTime.Now, Name = "Topic 4",   });

          foreach (var x in _Topic)
          {
            context.Topic.Add(x);
          }
          context.SaveChanges();
        }
        Topics = context.Topic.ToArray();
      };      
      seed_HomePages();
      seed_Courses();
      seed_Lectures();
      ...
      if (!context.Course_Lecture.Any())
      {
        var _Course_Lecture = new Course_Lecture[]
        {
            ...
            new Course_Lecture { CourseId = 1, LectureId = 2 },

            new Course_Lecture { CourseId = 1, LectureId = 3 },
      ...
      if (!context.Lecture_Topic.Any())
      {
        var _Lecture_Topic = new Lecture_Topic[]
        {
            
            new Lecture_Topic { LectureId = 1, TopicId = 1 },

            new Lecture_Topic { LectureId = 2, TopicId = 2 },

            new Lecture_Topic { LectureId = 3, TopicId = 3 },

            new Lecture_Topic { LectureId = 3, TopicId = 4 },

        };
        foreach (var x in _Lecture_Topic)
        {
          context.Lecture_Topic.Add(x);
        }
        context.SaveChanges();
      }
      var Lecture_Topic = context.Lecture_Topic.ToArray();
