        ...
        return React.createElement("div", { className: "lazy-image" },
            ...
            this.props.can_edit ?
                React.createElement("div", { className: "image-controls" },
                    React.createElement("a", { className: "user control__button delete", style: !this.props.can_edit ? { pointerEvents: "none" } : {}, onClick: () => {
                        ...
                        React.createElement("img", { className: "control__icon", src: "/images/icon-remove.svg", alt: "Delete" })),
