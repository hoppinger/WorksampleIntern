...
namespace CourseAndLectures.Filters
{
  public class RestrictToUserTypeAttribute : ActionFilterAttribute
  {
    ...
    public override void OnActionExecuting(ActionExecutingContext context)
    {
      ...
      var _context = controller._context as CourseAndLecturesContext;
...
namespace CourseAndLectures
{
  public static class ApplicationSessionManager {
    public static bool Exists(this HttpContext HttpContext, CourseAndLecturesContext _context) {
      if (HttpContext.Request.Cookies.ContainsKey("CourseAndLecturesContext")) {
        var old_cookie = HttpContext.Request.Cookies["CourseAndLecturesContext"];
        var old_session = _context.Session.FirstOrDefault(s => s.CookieName == old_cookie);
        return old_session != null;
      }
      return false;
    }
    public static T Get<T>(this HttpContext HttpContext, CourseAndLecturesContext _context) {
      if (!HttpContext.Request.Cookies.ContainsKey("CourseAndLecturesContext"))
        return default(T);
      var old_cookie = HttpContext.Request.Cookies["CourseAndLecturesContext"];
      var old_session = _context.Session.FirstOrDefault(s => s.CookieName == old_cookie);
    ...
    public static void Set<T>(this HttpContext HttpContext, CourseAndLecturesContext _context, T payload) {
      var cookie = HttpContext.Request.Cookies["CourseAndLecturesContext"];
    ...
    public static void Login<T>(this HttpContext HttpContext, CourseAndLecturesContext _context, T payload) {
      HttpContext.Logout(_context);
      var random_id = PasswordHasher.RandomPassword;
      HttpContext.Response.Cookies.Append("CourseAndLecturesContext", random_id, 
    ...
    public static void Logout(this HttpContext HttpContext, CourseAndLecturesContext _context) {
      if (HttpContext.Request.Cookies.ContainsKey("CourseAndLecturesContext")) {
        var old_cookie = HttpContext.Request.Cookies["CourseAndLecturesContext"];
        var old_session = _context.Session.FirstOrDefault(s => s.CookieName == old_cookie);
        if (old_session != null) {
        ...
        HttpContext.Response.Cookies.Delete("CourseAndLecturesContext");
      }
    }
  }
}
